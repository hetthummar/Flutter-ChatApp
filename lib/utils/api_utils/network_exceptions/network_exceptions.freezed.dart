...
class _$NetworkExceptionsTearOff {
  ...
  DefaultError defaultError(String error, int errorCode) {
    return DefaultError(
      error,
      errorCode,
    );
...
class _$DefaultError implements DefaultError {
  const _$DefaultError(this.error, this.errorCode);
...
abstract class DefaultError implements NetworkExceptions {
  const factory DefaultError(String error, int errorCode) = _$DefaultError;
